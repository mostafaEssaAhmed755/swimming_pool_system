				...
				<div class="page-content">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">أضافه وظيفه</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">أضافه وظيفه</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									...
									<form class="card-body row" action="{{ route('job.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
									@csrf
