                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group pull-right">
                                                            <a href="{{ route('employee.create') }}" id="addRow"
                                                                class="btn btn-info">
                                                                أضافه موظف <i class="fa fa-plus"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-scrollable">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="odd gradeX" onclick="window.location.href = '{{ route('employee.show',$employee->id) }}'">
                                                                ...
                                                                <td>{{ $employee->name }}</td>
                                                                <td class="left">{{ $employee->identification }}</td>
                                                                <td><a href="tel:{{ $employee->mobile }}">{{ $employee->mobile_1 }}</a></td>
                                                                <td class="left">{{ date('Y-m-d',strtotime($employee->joinDate))  }}</td>
                                                                <td class="left">{{ $employee->salary }}</td>
                                                                @php
                                                                $username = App\User::find($employee->user_id);
                                                                if($username)
                                                                   {
                                                         ...
                                                         <td class="left">{{ $username }}</td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <form action="{{ route('employee.destroy', $employee->id) }}" method="post" style="display: inline-block">
                                                                        ...
                                                                        <button type="submit" class="btn btn-danger btn-xs" onClick="return confirm('هل انت متأكد من حذف هذا الموظف؟')">
