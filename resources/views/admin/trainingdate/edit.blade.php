				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">تعديل بيانات التمرين</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="{{ route('home') }}">الرئيسيه</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="">التمارين</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">تعديل بيانات التمرين</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									...
									<form class="card-body row" action="{{ route('gymnastic.update',$gymnastic->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
									@csrf
                                    @method('PUT')
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" 
											 name="name" value="{{ $gymnastic->name }}">
