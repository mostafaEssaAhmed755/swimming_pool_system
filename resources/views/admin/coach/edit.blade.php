					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">تعديل بيانات المدرب</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									...
									<form class="card-body row" action="{{ route('coach.update',$coach->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
									@csrf
                                    @method('PUT')
									...
									<div class="col-lg-6 p-t-20">
										...
										@enderror">
											<input class="mdl-textfield__input" type="text"
											 name="identification" value="{{ $coach->identification }}" pattern="^[0-9]+$">
										...
										@enderror">
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="mobile"
												 name="mobile" value="{{ $coach->mobile }}">
									...
									@enderror">
											<textarea class="mdl-textfield__input" rows="1" id="adress"
											 name="adress" >{{ $coach->adress }}</textarea>
