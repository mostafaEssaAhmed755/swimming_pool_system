                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <div class="pull-left" >
                                <a class="btn btn-primary" href="{{ route('roles.index') }}"> عودة</a>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (count($errors) > 0)
                        <div class="alert alert-danger">
                            <strong>خطأ!</strong>توجد مشاكل بالمدخلات<br><br>
                            <ul>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                @foreach($permission as $value)
                                    <label style="display: inline-block">{{ Form::checkbox('permission[]', $value->id, false, array('class' => 'name')) }}
                                    {{ $value->name }}</label>
                                <br/>
                                @endforeach
                            </div>
