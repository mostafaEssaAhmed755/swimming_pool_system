				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">تعديل بيانات المشترك</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">تعديل بيانات المشترك</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									...
									<form class="card-body row" action="{{ route('student.update',$student->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
									@csrf
                                    @method('PUT')
									...
									<div class="col-lg-6 p-t-20">
										...
										@enderror">
											<input class="mdl-textfield__input" type="text" id="age"
											 name="age" value="{{ $student->age }}" pattern="^[0-9]+$">
									...
									<div class="col-lg-6 p-t-20">
										...
										@enderror">
											<input class="mdl-textfield__input" type="text"
											 name="identification" value="{{ $student->identification }}" pattern="^[0-9]+$">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        ...
                                        <div class="input-group has-validation ">
                                            <select class="form-control @error('gender') {{ 'is-invalid' }} @enderror" id="gender"  name="gender" required>
                                                <option value="1" {{ $student->gender == '1'?'selected':'' }} >زكر</option>
                                                <option value="2" {{ $student->gender == '2'?'selected':'' }}>انثي</option>
                                            </select>
                                            @error('gender')
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width @error('point')
											{{ 'is-invalid' }}
										@enderror">
											<input class="mdl-textfield__input" type="text" id="Points" pattern="^[0-9]+$"
											 name="point" value="{{ $student->point }}">
											<label class="mdl-textfield__label">عدد الحصص المتبقي</label>
											@error('point')
												<span class="mdl-textfield__error">{{ $message }}</span>
											@enderror
										</div>
									...
									@enderror">
											<textarea class="mdl-textfield__input" rows="1" id="adress"
											 name="adress" >{{ $student->adress }}</textarea>
									...
									<div class="col-lg-6 p-t-20">
										...
										@enderror">
											<input class="mdl-textfield__input" type="text" id="parentNam"
											 name="parentNam" value="{{ $student->parentNam }}">
											<label class="mdl-textfield__label">اسم ولى الامر</label>
											@error('parentNam')
												<span class="mdl-textfield__error">{{ $message }}</span>
											@enderror
										</div>
									...
									<div class="col-lg-6 p-t-20">
										...
										@enderror">
											...
											<label class="mdl-textfield__label" for="parentNum">رقم موبايل ولي الامر</label>
												@error('parentNum')
												<span class="mdl-textfield__error">{{ $message }}</span>
											@enderror										</div>
									</div>
